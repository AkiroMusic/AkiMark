...
> ⚠️ **Beta** — This is an informal preview release (v0.2.5). Features and behavior may change; expect rough edges.
...
> ⚠️ **内测版** — 这是非正式的内测预览版（v0.2.5）。功能与行为可能随时调整，可能尚有不完善之处。
